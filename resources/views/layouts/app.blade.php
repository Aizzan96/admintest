...
<head>
    ...
    <link href="{{ asset('outsidecss/bootstrap.min.css') }}" rel="stylesheet">


    <link href="{{ asset('outsidecss/font-awesome.min.css') }}" rel="stylesheet">

    <link href="{{ asset('outsidecss/nprogress.css') }}" rel="stylesheet">

    <link href="{{ asset('outsidecss/green.css') }}" rel="stylesheet">

    <link href="{{ asset('outsidecss/bootstrap-progressbar-3.3.4.min.css') }}" rel="stylesheet">

    <link href="{{ asset('outsidecss/jqvmap.min.css') }}" rel="stylesheet" />

    <link href="{{ asset('outsidecss/daterangepicker.css') }}" rel="stylesheet">

    <link href="{{ asset('outsidecss/custom.min.css') }}" rel="stylesheet">
    <meta name="robots" content="noindex, nofollow">
    <script nonce="4743df90-1ed9-4a6c-92cd-b0db1440b89f">
        (function(w, d) {
...
<body class="nav-md">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="images/img.jpg" alt="no pic" class="img-circle profile_img">
                        </div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816"
        ...
        data-cf-beacon='{"rayId":"7cc3cce679f713e4","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2023.4.0","si":100}'
